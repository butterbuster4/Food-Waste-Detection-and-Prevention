...
import com.plt.grp05h5.config.DateTimeFormatConfiguration;
...
public class JacksonUtils {
    ...
    public static <T> T fromJson(String json, TypeReference<T> typeRef, String zoneIdStr) {
        try {
    ...
    public static ObjectMapper getZoneIdObjectMapper(String zoneIdStr) {
        ZoneId zoneId = Buildins.function().getZoneFromGlobalOrDefault(zoneIdStr);
