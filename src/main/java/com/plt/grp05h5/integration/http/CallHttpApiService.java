...
import com.plt.grp05h5.config.JacksonConfiguration;
...
import com.plt.grp05h5.util.XmlMessageConverter;
...
public class CallHttpApiService implements RemoteCallApi{
    ...
    public <T, R> RemoteCallResponse<R> call(RemoteCallRequest<T, R> request) {
        ...
        try {
            ...
            throw ErrorManager.ofInterfaceError(e.getMessage(), e.getRawStatusCode(), e.getResponseBodyAsString());
        } catch (Exception e) {
            throw ErrorManager.ofInterfaceError(e.getMessage(),500,e.getMessage());
        }
    }
    ...
    private RestTemplate buildRestTemplate(Boolean openSsl) {
        ...
        javaTimeModule
                ...
                .addKeySerializer(LocalTime.class,new JacksonConfiguration.LcpLocalTimeKeySerializer())
                .addKeySerializer(ZonedDateTime.class,new JacksonConfiguration.LcpZonedDateTimeKeySerializer())
                .addKeySerializer(LocalDate.class,new JacksonConfiguration.LcpLocalDateKeySerializer())
                .addKeyDeserializer(LocalTime.class,new JacksonConfiguration.LcpLocalTimeKeyDeserializer())
                .addKeyDeserializer(ZonedDateTime.class,new JacksonConfiguration.LcpZonedDateTimeKeyDeserializer())
                .addKeyDeserializer(LocalDate.class,new JacksonConfiguration.LcpLocalTimeKeyDeserializer());
