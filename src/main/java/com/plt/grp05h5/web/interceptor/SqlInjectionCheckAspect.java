...
import com.plt.grp05h5.util.SqlKeywordsUtils;
import com.plt.grp05h5.web.interceptor.annotation.SqlInjectionCheck;
...
public class SqlInjectionCheckAspect {
    ...
    @Pointcut(value = "@annotation(com.plt.grp05h5.web.interceptor.annotation.SqlInjectionCheck)")
