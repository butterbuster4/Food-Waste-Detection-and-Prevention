...
import com.plt.grp05h5.web.validation.Validation;
import com.plt.grp05h5.web.validation.ValidationRule;
import com.plt.grp05h5.web.validation.ValidationRuleGroup;
import com.plt.grp05h5.web.validation.Validator;
...
public class ValidationAspect {
    ...
    private static final boolean onDemandInterfaceGeneration = false;

    @Pointcut(
            "@annotation(com.plt.grp05h5.web.validation.Validation)"
    )
    ...
    public Object validateAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (null == matchedValidationRuleGroup && onDemandInterfaceGeneration) {
                    ...
                    if (serviceField != null) {
                        ...
                        if (handleDefaultValueMethod != null) {
                            ...
                            if (restController) {
                                ...
                                // 获取逻辑接口默认值
                                handleDefaultValueMethod.invoke(serviceInstance, joinPoint.getArgs()[0]);
                            }
                        }
                    }
                }
